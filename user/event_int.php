        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    ...
                    <img class="img-fluid rounded" src="<?php echo '../admin Panel/admin/image_events/' . htmlspecialchars($rows['image1']); ?>" style="width: 350px; height: 320px;" alt="Client Image">
                    <img class="img-fluid rounded" src="<?php echo '../admin Panel/admin/image_events/' . htmlspecialchars($rows['image2']); ?>" style="width: 350px; height: 320px;" alt="Client Image">
