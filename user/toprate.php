                ...
                <div class="col-lg-4">
                    ...
                    <img src="https://media.istockphoto.com/id/1027859140/photo/group-of-managers-talking-in-the-business-cente.jpg?s=612x612&w=0&k=20&c=K5WjRHd_9I_WSxV7ENQb3fdXpdb0hsXmI-VwtTD44M0=" class="card-img-top" alt="...">
                        ...
                        <h1 class="mb-0"></h1>
                            ...
                            <p class="card-text">Create a seamless booking experience across your portfolio,Making smarter real estate decisions with real-time that  help employees collaborate in person,.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
